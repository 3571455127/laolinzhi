                ...
                <div class="left col-lg-4 col-md-4 col-sm-4">
                    <div class="list">
                        <!-- <div class="sidebar-nav">
                            <ul class="first-nav">
                               <?php $n=0;foreach($Categorys as $key=>$r):if($n<100) :if( intval(0)==$r["parentid"] ) :++$n; if($r[catname] != 'THANKS' && !in_array($r[id],array(77,112,113,78,194,159,160,161,162,163,189,190,191,192,193))): ?><li class=" <?php if($bcid==$r[id]) : ?>active<?php endif;?>"><a href="<?php if($r[child]==1) : ?>#menui<?php echo ($r[id]); else : echo ($r["url"]); endif;?>" <?php if($r[child]==1) : ?>data-toggle="collapse"<?php endif;?>><?php echo ($r["catname"]); ?>
